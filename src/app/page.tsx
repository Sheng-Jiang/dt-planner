            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div className="space-y-4">
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">Scalable cloud infrastructure with auto-scaling and global distribution</p>
                </div>
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">Zero-trust security model with identity management</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-green-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">Unified data platform for structured and unstructured data</p>
                </div>
                ...
                <div className="bg-green-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">Automated machine learning and predictive analytics</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-purple-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">Cross-platform mobile apps with offline capabilities</p>
                </div>
                ...
                <div className="bg-purple-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">Centralized API management and microservices architecture</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 p-4 bg-gray-100 rounded-lg">
              ...
              <div className="space-y-2">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm">Phase 1: Cloud Infrastructure Setup (3-6 months)</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center text-white text-xs">2</div>
                  <span className="text-sm">Phase 2: Data Platform Implementation (6-9 months)</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-6 h-6 bg-purple-500 rounded-full flex items-center justify-center text-white text-xs">3</div>
                  <span className="text-sm">Phase 3: Application Modernization (9-12 months)</span>
                </div>
              </div>
            </div>
          </div>
